...
//    }
    ...
    private function verifyEmailAccountMail(): bool {
        ...
        //        TODO::IMPLEMNET ROUTE TO HANDLE THIS IN HTACCESS
        ...
        $uniqueLinkTxt = $this->recipientName. Utilities::$accountVerificationText . "https://www.centralplay.co.zw/acc_ver/email/".$this->recipientEmail."/verification/".$this->verificationCode. "\n. Click the Above link to Verify Your Account. Please verify your Account within 10 minutes. \n Your Token Expires in 10 minutes.";
