...
class UserContr extends User
{
     ...
     */
    protected function setCFirstname(string $cFirstname): void
    {
        $cFirstname1 = Utilities::cleanData($cFirstname);
        $this->setUserFirstName($cFirstname1);
    }

    /**
     * @param string $cLastname
     */
    protected function setCLastname(string $cLastname): void
    {
        $cLastname1 = Utilities::cleanData($cLastname);
        $this->setUserLastName($cLastname1);
    }
    ...
    public function setCEarnings(float $earnings): void
    {
    ...
    public function setCAdminEarnings(float $adminEarnings): void
    {
        parent::setAdminEarnings($adminEarnings); // TODO: Change the autogenerated stub
    }
