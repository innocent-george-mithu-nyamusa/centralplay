...
class AdditionalItem extends Dbh
{
    ...
    private function createAdditionalItem(): bool
    {
        ...
        try {
            $additionalItemQuery = "INSERT INTO item_additional(additional_item_id, additional_item_name, additional_item_value, additional_item_parent_id, additional_item_description) ";
            $additionalItemQuery .= "VALUES(:addItemId, :addItemName, :addItemValue, :parentId, :addItemDescription)";
