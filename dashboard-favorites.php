...
<!-- Mirrored from progression-studios.com/skrn/dashboard-favorites.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Sep 2021 14:37:49 GMT -->
<head>
		<meta charset="utf-8">
		...
		<main id="col-main-with-sidebar">
			...
			<div class="dashboard-container">
				...
				<ul class="dashboard-sub-menu">
					<li><a href="dashboard-profile.php">Recommended</a></li>
					<li class="current"><a href="dashboard-favorites.php">Favorites</a></li>
