...
<head>
		...
		<title> Welcome- Select Category | Central Play</title>
	</head>
	<body>
				...
				<ul id="registration-steps-pro">
					...
					<li class="current-menu-item">
						<a href="signup-step4.php">
							...
							<h5 class="registration-step-title">Welcome to Central Play!</h5>
						</a>
					</li>
				</ul>
				...
				<div class="container">
						<div class="registration-steps-page-container">
							...
							<div class="registration-step-final-padding">
								<h2 class="registration-final-heading">Welcome <span><?php echo $_SESSION["userDetailFullName"] ?>!</span> Just a few more steps to complete your account</h2>
...
<!-- Mirrored from progression-studios.com/skrn/signup-step4.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Sep 2021 14:39:49 GMT -->
</html>