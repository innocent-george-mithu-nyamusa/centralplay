...
<!-- Mirrored from progression-studios.com/skrn/dashboard-profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Sep 2021 14:37:41 GMT -->
<head>
		<meta charset="utf-8">
      ...
      <header id="videohead-pro" class="sticky-header">
		...
		<div id="content-sidebar-pro">
			...
			<div id="content-sidebar-info">
				<img src="images/demo/profile-image-sidebar.jpg" alt="Suzie">
				<div id="profile-sidebar-name">
					<h5>Suzie Smith</h5>
					<h6>Manila, Philippines</h6>
				</div>
				<div id="profile-sidebar-gradient"></div>
				<a href="dashboard-account.php" class="edit-profile-sidebar"><i class="fas fa-pencil-alt"></i></a>
			</div>
		...
		<main id="col-main-with-sidebar">
			...
			<div class="dashboard-container">
				...
				<ul class="dashboard-sub-menu">
					<li class="current"><a href="dashboard-profile.php">Recommended</a></li>
...
<!-- Mirrored from progression-studios.com/skrn/dashboard-profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Sep 2021 14:37:49 GMT -->
</html>