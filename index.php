    ...
    <ul class="slides">
        <li class="progression_studios_animate_in">
            <div class="progression-studios-slider-image-background"
                 style="background-image:url(images/demo/slide-1.jpg);">
                        ...
                        <div class="container">
                            ...
                            <div class="progression-studios-slider-caption-width">
                                <div class="progression-studios-slider-caption-align">
                                    <h2>Welcome to Central Play<span style="color:#3db13d;">.</span></h2>
                                    <h6>Watch the largest collection of Movies and TV series anytime anywhere!</h6>
                                    <a class="btn btn-green-pro btn-slider-pro btn-shadow-pro" href="signup-step1.php"
                                       role="button">Start Your Free Trial</a>
        ...
        <li class="progression_studios_animate_right">
            <div class="progression-studios-slider-image-background"
                 style="background-image:url(images/demo/slide-2.jpg); background-color:#111015;">
                <div class="progression-studios-slider-display-table">
                    <div class="progression-studios-slider-vertical-align">
        ...
        <li class="progression_studios_animate_left">
            <div class="progression-studios-slider-image-background"
                 style="background-image:url(images/demo/slide-3.jpg);">
                <div class="progression-studios-slider-display-table">
                    <div class="progression-studios-slider-vertical-align">
                        ...
                        <div class="container">
                            ...
                            <div class="progression-studios-slider-caption-width">
                                <div class="progression-studios-slider-caption-align">
                                    <h2>Wadiwa Wepamoyo Season 1</h2>
                                    <h6>Watch the best collection of Movies and TV series anytime anywhere!</h6>
                                    <a class="btn btn-green-pro btn-slider-pro btn-shadow-pro" href="signup-step1.php"
                                       role="button">Start Your Free Trial</a>
                                </div><!-- close .progression-studios-slider-caption-align -->
                            </div><!-- close .progression-studios-slider-caption-width -->
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md my-auto"><!-- .my-auto vertically centers contents -->
                ...
                <p>Our platform is designed so that you can Watch, Stream and Enjoy yourself from anywhere on any
                    device.</p>
        ...
        <div class="row">
            <div class="col-md my-auto"><!-- .my-auto vertically centers contents -->
                ...
                <p>You have total power over what to view at any time. You can make your own playlist</p>
                <div style="height:15px;"></div>
        ...
        <div class="row">
            ...
            <div class="col-md my-auto"><!-- .my-auto vertically centers contents -->
                ...
                <p>Watch your Videos in Ultra High Definition. Enjoy the best experience of the video</p>
                <div style="height:15px;"></div>
...
<!-- Mirrored from progression-studios.com/skrn/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Sep 2021 14:38:28 GMT -->
</html>