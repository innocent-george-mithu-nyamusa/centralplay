...
<!-- Mirrored from progression-studios.com/skrn/dashboard-account.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Sep 2021 14:37:49 GMT -->
<head>
		<meta charset="utf-8">
		...
		<main id="col-main">
			...
			<div class="dashboard-container">
				...
				<ul class="dashboard-sub-menu">
					<li class="current"><a href="dashboard-account.php">Account Settings</a></li>
					<li><a href="dashboard-account-payment.php">Payment Info</a></li>
					...
					<div class="row">
						...
						<div class="col-12  col-lg-3">
							<div id="account-edit-photo">
								<div><img src="images/demo/account-profile.jpg" alt="Account Image"></div>
						...
						<div class="col">
							...
							<p class="small-paragraph-spacing">Pick your favorite genres for content.</p>
								...
								<div class="clearfix"></div>
							<hr>
							<p><a href="dashboard-account.php" class="btn btn-green-pro">Save Changes</a></p>
							<br>
							</form>
...
<!-- Mirrored from progression-studios.com/skrn/dashboard-account.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Sep 2021 14:37:53 GMT -->
</html>