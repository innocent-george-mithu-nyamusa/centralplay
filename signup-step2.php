                ...
                <form class="registration-steps-form" id="register-form" method="post" action="">
                    ...
                    <div class="registration-social-login-container">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="user_fullname" class="form-control" id="full-name"
                        ...
                        <!--								 <div class="registration-social-login-or">or</div>-->
                    							 ...
                    							 <div class="registration-social-login-options">
                    							 	<h2>Sign up With Central Play</h2>
                                                    <p> Welcome to Central Play. A place you can access your local Zimbabwean Content from or away from home</p>
                    ...
                    <div class="form-group last-form-group-continue">
                        ...
                        <span class="checkbox-remember-pro"><input type="checkbox" id="checkbox-terms"><label
                                    for="checkbox-terms" class="col-form-label">By clicking "Continue", you agree to our <a
